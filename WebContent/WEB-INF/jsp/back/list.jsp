...
<body style="background: #e1e9eb;">
	<form action="<%=basePath%>List.action" id="mainForm" name="mainForm"
		method="post">
			...
			<div class="rightCont">
				...
				<div class="zixun fix">
						...
						<tbody>
							...
							<c:forEach var="message" items="${messageList}"
								...
								<tr
									...
									<td><a href="#">修改</a>&nbsp;&nbsp;&nbsp; <a
										href="javascript:deleteOne('<%=basePath%>', '${message.id}')">删除</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
					...
					<div class='page fix'>
						...
						跳至&nbsp;<input type='text' id='currentPageText' value=${page.currentPage} class='allInput w28' />&nbsp;页&nbsp; <a
							href="javascript:changeCurrentPage($('#currentPageText').val())" class='go'>GO</a>
					</div>
				</div>
			</div>
		</div>
